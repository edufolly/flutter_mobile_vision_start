...
import 'package:flutter_mobile_vision_start/barcode_detail.dart';
import 'package:flutter_mobile_vision_start/face_detail.dart';
import 'package:flutter_mobile_vision_start/ocr_text_detail.dart';
  ...
  Widget _getBarcodeScreen(BuildContext context) {
    ...
    items.addAll(
      ListTile.divideTiles(
        context: context,
        tiles: _barcodes.map((barcode) => BarcodeWidget(barcode)).toList(),
      ),
    );
